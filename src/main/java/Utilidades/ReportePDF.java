...
public class ReportePDF {
	...
	static String routeImageReport = "./src/test/resources/images/logo_periferia.png";
	...
	public static void createTemplate(File folderPath, String nameTest, String evidencePDF, String analyst, String url) {
		try {
			if (evidencePDF.equals("SI")) {
				font.setColor(BaseColor.GRAY);
				font.setFamily("ITALIC");
				archivo = new FileOutputStream(folderPath + "\\" + "Reporte " + nameTest + " " + horaSinFormato + ".pdf");
				PdfWriter writer = PdfWriter.getInstance(documento, archivo);
				Image logoHeader = Image.getInstance(routeImageReport);
	...
	public static void createBody(String steps, String imagePath) throws DocumentException, MalformedURLException, IOException {
	...
	public static void createErrorBody(String steps, String imagePath, String errorMessage) throws DocumentException, MalformedURLException, IOException {
		Paragraph parrafo = new Paragraph();// OBTENER EL NOMBRE DEL LOCALIZADOR
		parrafo.setAlignment(Chunk.ALIGN_LEFT);
		parrafo.setFont(FontFactory.getFont("Times", 8, Font.NORMAL, BaseColor.GRAY));
		parrafo.add("Acci�n: " + steps);
		documento.add(parrafo);
		Image imagen = Image.getInstance(imagePath);
