...
public class MyScreenRecorder extends ScreenRecorder {
	...
	public static void starRecording(String methodName, File folderPath, String evidenceRecording)  {
		if(evidenceRecording.equals("SI")) {
			...
			System.out.println("NO SE GENERO EVIDENCIA EN VIDEO");
		}
	...
	public static void StopRecording() {
		...
		System.out.println("Finaliza la grabacion");
	}
}